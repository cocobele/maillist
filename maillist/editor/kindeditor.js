...
KE.setting = {
	...
	items : [
		...
		'flash', 'media', 'table', 'hr','extraval', 'emoticons', 'link', 'unlink', '|', 'about'
	],
	colorTable : [
...
KE.plugin['about'] = {
	click : function(id) {
		...
		//var str=document.form1.SwitchVal.options[document.form1.SwitchVal.selectedIndex].value;
		//var selobj=document.getElementById('SwitchVal');
		//var str=selobj.options[selobj.selectedIndex].value;
		//var str=document.formdialog.SwitchVal.options[document.formdialog.SwitchVal.selectedIndex].value;
	    	str="{%%"+str+"%%}";
